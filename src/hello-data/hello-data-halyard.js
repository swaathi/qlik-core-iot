...
(async () => {
  try {
    ...
    const properties = {
      ...
      qHyperCubeDef: {
        qDimensions: [{ qDef: { qFieldDefs: ['time'] } }],
        qInitialDataFetch: [{ qHeight: timestampCount, qWidth: 1 }],
      },
    };
    ...
    console.log(`Listing the ${timestampCount} first time stamps:`);
